...
# The 8 categorical columns that need encoding before scaling
CATEGORICAL_COLS = [
    "CODE_GENDER", "NAME_EDUCATION_TYPE", "NAME_FAMILY_STATUS",
    "NAME_HOUSING_TYPE", "NAME_INCOME_TYPE", "NAME_CONTRACT_TYPE",
    ...
    for col in CATEGORICAL_COLS:
        ...
        if value not in le.classes_:
            return LoanPredictionOutput(
                ...
                prediction=0,
                risk_level=f"Error: unknown value '{value}, for {col}. Expected one of {list[le.classes_]}",
            )
